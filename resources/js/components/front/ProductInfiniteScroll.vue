<template>
  <div>
    ...
    <div v-if="products.length > 0" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mt-8">
      <a 
...
onMounted(() => {
  // Only setup observer if we have exactly 40 items (meaning there might be more)
  if (props.initialCount >= 40) {
